...
Projet personnel de **fiction** : **183 personnages géolocalisés et illustrés**
dans la ville de Saguenay (arrondissements de La Baie, Chicoutimi et
Jonquière, Québec), dont **182 humains et 1 animal**. Les personnages, noms,
...
📇 **Planche contact des 183 portraits** : [`portraits/planche-contact-generale.webp`](portraits/planche-contact-generale.webp).
...
|---|---|
| `data/personnages.csv` | **Source de vérité** : 183 lignes × 16 colonnes, UTF-8 `;`. C'est le seul fichier à éditer à la main. |
...
| `base_personnages_fictifs.xlsx` | Classeur **public** : *Personnages* (183 × 16) + *Lisez-moi*. **Sans** la narration. |
...
| `tests/test_base.py` | **39 garde-fous** couvrant toutes les conventions, lancés en CI. |
...
# 4. contrôler la base
python3 -m unittest discover -s tests -v   # 39 garde-fous
ruff check .                               # lint
```
...
- Les **39 garde-fous** vérifient notamment : effectifs et cohérence des 4
