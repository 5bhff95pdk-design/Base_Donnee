# Archive — analyse initiale à 173 personnages et suivis intermédiaires

> **Document historique, non représentatif de l’état actuel.** Conservé pour
> retracer les décisions du 2026-09-13. Les effectifs, nombres de colonnes/tests,
> statuts de narration et résultats de CI mentionnés ci-dessous correspondent
> à des étapes successives anciennes, et non à une nouvelle vérification.
> Consultez [l’état actuel](../analyse-projet.md) et le [guide courant](../../README.md).
> Le corps d’origine est conservé ; seuls les liens relatifs ont été adaptés.
